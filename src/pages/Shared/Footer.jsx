                ...
                <form action="#">
                  <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-gray-500 sm:rounded-none sm:rounded-r-lg"
                      >
                        Subscribe
                      </button>
                    </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4 hover:underline">Summer Tutoring</li>
                <li className="mb-4 hover:underline">Cabins & Facilities</li>
                <li className="mb-4 hover:underline">Watch the Video</li>
                <li className="hover:underline"> Camp Activities</li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-sm font-bold uppercase text-white">
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4 hover:underline">Welcome Message</li>
                <li className="mb-4 hover:underline">Why Choose Us</li>
                <li className="mb-4 hover:underline">Our Directors</li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-sm font-bold uppercase text-white">
